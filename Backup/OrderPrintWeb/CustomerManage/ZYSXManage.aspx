<%@ Page Language="C#" AutoEventWireup="true" Inherits="CustomerManage_ZYSXManage" Codebehind="ZYSXManage.aspx.cs" %>
            ...
            <div id="ListArea" class="listarea">
                <div id="OptArea" class="optarea">
                    ...
                    <div class="fr">
                        ...
                        <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./CustomerManage/AddZYSX.aspx','编辑发货前注意事项','40%','50%')" src="~/themes/default/images/btn/btn_new_w_h.png" alt="添加" title="添加" />
                    </div>
                </div>
                <div id="List" class="listS" style=" height: 500px;  width:100%; overflow:auto;">
                            ...
                            <ItemTemplate>
                                <tr>
                                   ...
                                   <%-- <td>
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/AddZYSX.aspx?customerNo=<%# Eval("customerNo") %>','编辑注意事项','50%','60%')">
                                            编辑</a>
                                             <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/DetailZYSX.aspx?customerNo=<%# Eval("customerNo") %>','查看注意事项','50%','60%')">
                                            查看</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
