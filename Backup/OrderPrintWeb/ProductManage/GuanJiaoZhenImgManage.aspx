<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="ProductManage_GuanJiaoZhenImgManage" Codebehind="GuanJiaoZhenImgManage.aspx.cs" %>
            ...
            <ContentTemplate>
                <div id="ListArea" class="listarea">
                    <div id="OptArea" class="optarea">
                        ...
                        <div class="fr">
                            <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./ProductManage/AddGuanJiaoZhenImg.aspx','编辑管脚针信息','30%','70%')"
                            ...
                            <asp:Repeater ID="rpt_userinfo" runat="server"  OnItemCommand="rpt_userinfo_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void;" onclick="ListPageControl.OpenBox('./ProductManage/AddGuanJiaoZhenImg.aspx?id=<%# Eval("imgId") %>','编辑管脚针信息','30%','70%')">编辑</a>&nbsp;|&nbsp;
