<%@ Page Language="C#" AutoEventWireup="true" Inherits="CustomerManage_PriceManage" Codebehind="PriceManage.aspx.cs" %>
        ...
        <ContentTemplate>
            <div id="ListArea" class="listarea">
                <div id="OptArea" class="optarea">
                    ...
                    <div class="fr">
                        <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./CustomerManage/AddPrice.aspx','编辑单价','40%','40%')"
                        ...
                        <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/AddPrice.aspx?id=<%# Eval("priceId") %>','编辑单价','40%','40%')">
                                            编辑</a>&nbsp;|&nbsp;
                                        <asp:LinkButton ID="Button1" runat="server" Text="删除" CommandName="del" CommandArgument='<%#  Eval("priceId") %>'
