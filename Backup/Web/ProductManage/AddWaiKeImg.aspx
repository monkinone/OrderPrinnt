<%@ Page Language="C#" AutoEventWireup="true" Inherits="ProductManage_AddWaiKeImg" CodeBehind="AddWaiKeImg.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function isExistWaike() {
            if ($('#txtwaiKeNo').val() != "") {
                $.ajax({
                    type: "GET",
                    async: false,
                    url: "/Service/AddWaiKeImg.ashx",
                    data: {opr:"isExistWaike",waikeNo:$('#txtwaiKeNo').val()},
        ...
        <div class="details">
            <div class="rightinfo" id="RightInfoArea">
                <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                    ...
                    <tr>
                        <td class="info">
                            <asp:TextBox ID="txtwaiKeNo" runat="server" CssClass="tbox" datatype="*"
                                nullmsg="请输入外壳编号！" errormsg="请输入外壳编号！" onblur="isExistWaike()"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="title1">外壳图片：
                        </td>
                    </tr>
                    <tr>
                        <td class="info">
                            <asp:Image ID="imgwaiKeImg" runat="server" Style="max-width: 900px; max-width: 550px;" /><br />
                            <asp:FileUpload ID="fuwaiKeImg" runat="server" CssClass="filebox" />
                        </td>
                    </tr>
                </table>
            </div>
