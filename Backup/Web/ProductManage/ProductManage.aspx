                        ...
                        <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./ProductManage/AddProduct.aspx?id=<%# Eval("productId") %>','编辑产品信息','70%','90%')">编辑</a>
                                        &nbsp;&nbsp;
                                      <!-- <a href="javascript:void;" onclick="ListPageControl.OpenBox('./ProductManage/DetailProduct.aspx?id=<%# Eval("productId") %>','预览产品信息','70%','90%')">预览</a>-->
                                        <a href="javascript:void;" onclick="window.open('/orderManage/PrintSGD.aspx?proType=<%#Eval("productNum")%>','预览产品信息','70%','90%')">预览</a>
                                        &nbsp;&nbsp;
