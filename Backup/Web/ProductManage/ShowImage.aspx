<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowImage.aspx.cs" Inherits="OrderPrintWeb.ProductManage.ShowImage" %>
        ...
        <div class="details">
            <div class="rightinfo" id="RightInfoArea">
                <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                    <tr>
                        <td class="info">
                            <asp:Image ID="img" runat="server" Style="max-width: 900px; max-width: 550px;" />
                        </td>
                    </tr>
                </table>
            </div>
