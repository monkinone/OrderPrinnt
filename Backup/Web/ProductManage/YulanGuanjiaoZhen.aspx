<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YulanGuanjiaoZhen.aspx.cs" Inherits="OrderPrintWeb.ProductManage.YulanGuanjiaoZhen" %>
                    ...
                    <table width="90%">
                        <tr>
                            <td class="title1 " colspan="2">
                                ...
                                <a href="YulanGuanjiaoZhen.aspx" title="管脚针图片" style="width: 100px; float: left; background: #004ea2;">管脚针图片</a>
                            </td>
                        </tr>
                        <tr>
                            <td class="title1">按管脚针型号
                            </td>
                            <td class="cond">
                                <input type="text" id="txt_guanJiaoZhenNo" runat="server" class="tbox" width="80%" />
                            </td>
                        </tr>
                            ...
                            <asp:Repeater ID="rpt_userinfo" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <img src='<%# Eval("guanJiaoZhenImg").ToString()!=""?"../"+Eval("guanJiaoZhenImg").ToString().Replace("~/",""):"/images/nophoto.jpg"%>' width="50"
                                                height="50" />
                                        </td>
                                        <td>
                                            <a href="javascript:void;" onclick="ListPageControl.OpenBox('./ProductManage/ShowImage.aspx?id=<%# Eval("guanJiaoZhenNo") %>&type=guanjiaozhen','预览图片','70%','90%')">预览</a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
