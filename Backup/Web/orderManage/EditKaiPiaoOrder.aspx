            ...
            <div class="rightinfo" id="RightInfoArea">
                <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="info">
                            <asp:TextBox ID="txtcustomNum" runat="server" CssClass="tbox" Rows="5" datatype="*"></asp:TextBox>
                        </td>
                        <td class="title1">合同编号：
                        </td>
                        <td class="info">
                            <asp:TextBox ID="txtheTongNum" runat="server" CssClass="tbox" datatype="*"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="info">
                            <asp:TextBox ID="txtcustomOrderNum" runat="server" CssClass="tbox" datatype="*"></asp:TextBox>
                        </td>
