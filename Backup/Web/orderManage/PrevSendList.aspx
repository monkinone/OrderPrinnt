...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function doPrint() {
            ...
            window.print();
            window.location.href = window.location.href + "&IsUpdate=false";
                ...
                <tr>
                    ...
                    <td class="optbtn">
                        ...
                        <%--   <input type="image" onclick="DetailsPageControl.CloseBox();" class="btn" src="../themes/default/images/btn/btn_close_w_h.png"
                            title="返回" />--%>
                        <asp:CheckBox ID="chkRepeatPrint" runat="server" Text="是否重复打印" />
                ...
                <table align="center">
                    <tr>
                        <td>
                            ...
                            <table class="form" cellpadding="0" cellspacing="0" style='width: 800px; margin-top: 10px; font-size: 11pt; color: #000; font-family: "黑体";' align="center">
                                <tr>
                                    <td style="width: 500px; font-size: 11pt; color: #000; font-family: '黑体';">收货单位Receiving unit：
                                        <asp:TextBox ID="txtCompanyName" CssClass="textbox" Width="575" BorderStyle="None" Font-Size="11pt" runat="server"></asp:TextBox></td>

                                    <td style="font-size: 11pt; color: #000; font-family: '黑体';">发货日期Shipped Date：
                                        <input class=" tbox" readonly="readonly" id="lblPrintTime" type="text" name="txtTime" onclick="WdatePicker()"
                                        runat="server" style="border: 0; border-bottom: 1px solid #ccc; font-size: 11pt; color: #000; font-family: '黑体';" /></td>
                                </tr>
                            </table>
                            ...
                            <table class="form " cellpadding="0" cellspacing="0" style='width: 800px; margin-top: 10px; font-size: 11pt; color: #000; font-family: "黑体"; text-align: right;' align="center">
                                <tr>
                                    <td>发货单位及经办人：师小如</td>
                                    <td></td>
