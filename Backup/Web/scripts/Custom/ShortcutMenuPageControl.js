...
//        TableID = div1[i].lang.toString();
//        if (TableID == "GWLZ") {  //公文流转
//            PowerCode = "'GWLZ','NBGWLZ'";
//            funajax(TableID, TaskCountHtml);
//        } else if (TableID == "XXGX") {  //信息共享
//            PowerCode = "'XXGX_ZBB','XXGX_HYJY','XXGX_GZZD','XXGX_GZYB','XXGX_KW','XXGX_GS','XXGX_QT'";
//            funajax(TableID, TaskCountHtml);
//        } else if (TableID == "LDQP") {  //公文领导签批
//            PowerCode = "'GWLZ','NBGWLZ'";
//            funajax(TableID, TaskCountHtml);
//        } else if (TableID == "BGYPTJCK") {    //办公用品统计
//            PowerCode = "'SPTJ','SQTJ','JDTJ'";
//            funajax(TableID, TaskCountHtml);
//        } else if (TableID == "DAMLGL") {    //档案管理借阅待审批
//            PowerCode = "'DASP'";
//            funajax(TableID, TaskCountHtml);
...
//                type: "Post",
//                async: false,
//                url: "/MyDesk/MyDesk.aspx/GetTSTypeCodeCount",
//                data: "{'PowerCode':\"" + "'" + TableID + "'" + "\"}",
//                contentType: "application/json;charset=utf-8", // 这句可不要忘了。
//                dataType: "json",
//                success: function (res) {
//                    if (!(res.d == "0")) {
//                        $("#sp_" + TableID + "").html(TaskCountHtml.replace(/@Count/g, res.d));
//                    } else {
//                        $("#sp_" + TableIDs + "").html("");
//                    }
//                },
...
//        if (TableID == "GWLZ") {  //公文流转
//            PowerCode = "'GWLZ','NBGWLZ'";
//            allfunajax(TableID, TaskCountHtml);
//        } else if (TableID == "XXGX") {  //信息共享
//            PowerCode = "'XXGX_ZBB','XXGX_HYJY','XXGX_GZZD','XXGX_GZYB','XXGX_KW','XXGX_GS','XXGX_QT'";
//            allfunajax(TableID, TaskCountHtml);
//        } else if (TableID == "LDQP") {  //公文领导签批
...
//                success: function (res) {
//                    if (!(res.d == "0")) {
//                        $("#qb_" + TableID + "").html(TaskCountHtml.replace(/@Count/g, res.d));
//                    } else {
//                        $("#qb_" + TableIDs + "").html("");
//                    }
//                },
...
//       
//    }
//    setTimeout("ShortcutMenuPageControl.SelWorkItemCount()", 300000);
}
