<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPrice.aspx.cs" Inherits="CustomerManage_AddPrice" %>
    ...
    <div class="details">
        <div class="rightinfo" id="RightInfoArea" style="width: auto">
            <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                ...
                <tr>
                    <td class="info">
                        <asp:TextBox ID="txtproductNO" runat="server" CssClass="tbox" Rows="5" datatype="*"
                ...
                <tr>
                    <td class="info">
                        <asp:TextBox ID="txtprice" runat="server" CssClass="tbox" Rows="5" ></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
