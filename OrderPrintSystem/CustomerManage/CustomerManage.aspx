<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerManage.aspx.cs" Inherits="CustomerManage_CustomerManage" %>
            ...
            <div id="QueryArea" class="queryarea">
                <table width="90%">
                    <tr>
                        ...
                        <td class="cond">
                            <input type="text" id="txt_companyName" runat="server" class="tbox" width="80%" />
                        </td>
                    </tr>
                    <tr>
                        <td class="title1">
        ...
        <ContentTemplate>
            <div id="ListArea" class="listarea">
                <div id="OptArea" class="optarea">
                    ...
                    <div class="fr">
                        <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./CustomerManage/AddCustomer.aspx','编辑客户信息','80%','90%')"
                        ...
                        <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/DetailZYSX.aspx?customerNo=<%# Eval("customerNo") %>','发货前注意事项','50%','60%')">
                                            发货前注意事项</a>&nbsp;|&nbsp;
                                        <a onclick="ListPageControl.OpenBox('./CustomerManage/ProductParamList.aspx?customerNo=<%# Eval("customerNo") %>','客户参数表','50%','60%')">客户参数表</a>&nbsp;|&nbsp;
                                        <a onclick="ListPageControl.OpenBox('./CustomerManage/PriceList.aspx?customerNo=<%# Eval("customerNo") %>','单价查询','50%','60%')">单价查询</a>
                                    </td>
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/AddCustomer.aspx?id=<%# Eval("customerId") %>','编辑客户信息','70%','90%')">
                                            编辑</a>&nbsp;|&nbsp;
