<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PriceManage.aspx.cs" Inherits="CustomerManage_PriceManage" %>
        ...
        <ContentTemplate>
            <div id="ListArea" class="listarea">
                <div id="OptArea" class="optarea">
                    ...
                    <div class="fr">
                        <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./CustomerManage/AddPrice.aspx','编辑单价','30%','50%')"
                        ...
                        <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/AddPrice.aspx?id=<%# Eval("priceId") %>','编辑单价','30%','50%')">
                                            编辑</a>&nbsp;|&nbsp;
