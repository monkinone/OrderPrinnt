<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWaiKeImg.aspx.cs" Inherits="ProductManage_AddWaiKeImg" %>
    ...
    <div class="details">
        <div class="rightinfo" id="RightInfoArea" style="width: auto">
            <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                ...
                <tr>
                    <td class="info">
                        <asp:TextBox ID="txtwaiKeNo" runat="server" CssClass="tbox" Rows="5" datatype="*"
                            nullmsg="请输入外壳编号！" errormsg="请输入外壳编号！"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="title1">
                ...
                <tr>
                    <td class="info">
                        <asp:Image ID="imgwaiKeImg" runat="server" />
                        <asp:FileUpload ID="fuwaiKeImg" runat="server" />
                    </td>
                </tr>
            </table>
        </div>
