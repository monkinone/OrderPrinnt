<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuanJiaoZhenImgManage.aspx.cs"
    Inherits="ProductManage_GuanJiaoZhenImgManage" %>
                            ...
                            <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../<%# Eval("guanJiaoZhenImg").ToString().Replace("~/","")%>" width="50"
                                                height="50" />
                                        </td>
                                        <td>
