<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WaiKeImgManage.aspx.cs" Inherits="ProductManage_WaiKeImgManage" %>
                        ...
                        <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../<%# Eval("waiKeImg").ToString().Replace("~/","")%>" width="50" height="50" />
                                    </td>
                                    <td>
