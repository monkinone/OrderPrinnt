<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWuliu.aspx.cs" Inherits="orderManage_AddWuliu" %>
        ...
        <div class="details">
            <div class="rightinfo" id="RightInfoArea" style="width: auto">
                <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                    ...
                    <tr>
                        <td class="info">
                            <asp:TextBox ID="txtsendNum" runat="server" CssClass="tbox" datatype="*"
                    ...
                    <tr>
                        <td class="info">
                            <asp:TextBox ID="txtpackingCompanyName" runat="server" CssClass="tbox" datatype="*"
