<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditOrder.aspx.cs" Inherits="orderManage_EditOrder" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function AddSignRow() { //读取最后一行的行号，存放在txtTRLastIndex文本框中 
            ...
            proType.innerHTML = "<input type='text' id='txtproType" + rowID + "' name='proType' size='20' datatype='*' nullmsg='请输入型号！'/>";

            //数量
            var shuliang = newTR.insertCell(3);
            shuliang.innerHTML = "数量";
            var proNum = newTR.insertCell(4);
            proNum.innerHTML = "<input type='text' id='txtproType" + rowID + "' name='proNum' size='20' datatype='*' nullmsg='请输入数量！'/>";

            //单价
            var danjia = newTR.insertCell(5);
            danjia.innerHTML = "单价";
            var ProPrice = newTR.insertCell(6);
            ProPrice.innerHTML = "<input type='text' id='txtproType" + rowID + "' name='ProPrice' size='20' datatype='*' nullmsg='请输入单价！'/>";
                ...
                <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="info">
                            <asp:TextBox ID="txtYikaipiaoMoney" runat="server" CssClass="tbox" ></asp:TextBox>
                        </td>
                        <td class="title1">已结款金额：
                        </td>
                        <td class="info">
                            <asp:TextBox ID="txtYijiekuanMoney" runat="server" CssClass="tbox"></asp:TextBox>
                        </td>
                        <td class="title1">
                        </td>
                        <td class="info">
