<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendListOrAddSend.aspx.cs" Inherits="orderManage_SendListOrAddSend" %>
                            ...
                            <asp:Repeater ID="rpt_userinfo" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><a onclick="ListPageControl.OpenBox('./orderManage/AddWuliu.aspx?id=<%#Eval("orderNum") %>','编辑发货明细','30%','50%')">录入发货明细</a></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </table>
