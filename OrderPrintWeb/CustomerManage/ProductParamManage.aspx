<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="ProductParamManage" Codebehind="ProductParamManage.aspx.cs" %>
        ...
        <ContentTemplate>
            <div id="ListArea" class="listarea">
                <div id="OptArea" class="optarea">
                    ...
                    <div class="fr">
                        <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./CustomerManage/AddProductParam.aspx','编辑客户产品参数信息','40%','50%')"
                            ...
                            <ItemTemplate>
                                <tr>
                                   ...
                                   <%-- <td>
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./CustomerManage/AddProductParam.aspx?id=<%# Eval("paramId") %>','编辑客户产品参数信息','40%','50%')">
                                            编辑</a>&nbsp;|&nbsp;
