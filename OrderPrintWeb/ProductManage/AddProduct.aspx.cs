...
public partial class ProductManage_AddProduct : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (UserInfo.UserType == 2)
            {
                ...
                // this.ClientScript.RegisterStartupScript(this.GetType(), "", "function FCKeditor_OnComplete(editorInstance) {editorInstance.EditorDocument.body.disabled = true;}", true);
    ...
    protected void Save_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request.QueryString["id"] != "" && Request.QueryString["id"] != null)
        {
            ...
            {
                mod.GujiaCount = Convert.ToInt32(txtgujiaCount.Text.Trim());
            }
            else
            {
                mod.GujiaCount = 0;
            ...
            {
                mod.TongpaoCount = Convert.ToInt32(txttongpaiCount.Text.Trim());
            }
            else
            {
                mod.TongpaoCount = 0;
            ...
            {
                mod.CihuanCount = Convert.ToInt32(txtcihuanCount.Text.Trim());
            }
            else { mod.CihuanCount = 0; }
            mod.DuanziCanshu = txtduanziCanshu.Text.Trim();
            if (txtduanziCount.Text.Trim() != "")
            { mod.DuanziCount = Convert.ToInt32(txtduanziCount.Text.Trim()); }
            else { mod.DuanziCount = 0; }
            mod.XianlubanCanshu = txtxianlubanCanshu.Text.Trim();
            if (txtxianlubanCount.Text.Trim() != "") { mod.XianlubanCount = Convert.ToInt32(txtxianlubanCount.Text.Trim()); } else { mod.XianlubanCount = 0; }
            mod.JiaopianCanshu = txtjiaopianCanshu.Text.Trim();
            if (txtjiaopianCount.Text.Trim() != "") { mod.JiaopianCount = Convert.ToInt32(txtjiaopianCount.Text.Trim()); } else { mod.JiaopianCount = 0; }
            mod.PingbiCanshu = txtpingbiCanshu.Text.Trim();
            if (txtpingbiCount.Text.Trim() != "") { mod.PingbiCount = Convert.ToInt32(txtpingbiCount.Text.Trim()); } else { mod.PingbiCount = 0; }
            mod.WenyaguanCanshu = txtwenyaguanCanshu.Text.Trim();
            if (txtwenyaguanCount.Text.Trim() != "") { mod.WenyaguanCount = Convert.ToInt32(txtwenyaguanCount.Text.Trim()); } else { mod.WenyaguanCount = 0; }
            mod.DianzuCanshu = txtdianzuCanshu.Text.Trim();
            if (txtdianzuCount.Text.Trim() != "")
            {
                mod.DianzuCount = Convert.ToInt32(txtdianzuCount.Text.Trim());
            }
            else
            {
                mod.DianzuCount = 0;
            ...
            {
                mod.LuosiCount = Convert.ToInt32(txtluosiCount.Text.Trim());
            }
            else { mod.LuosiCount = 0; }
            mod.ResuotaoguanCanshu = txtresuotaoguanCanshu.Text.Trim();
            if (txtresuotaoguanCount.Text.Trim() != "")
            {
                mod.ResuotaoguanCount = Convert.ToInt32(txtresuotaoguanCount.Text.Trim());
            }
            else { mod.ResuotaoguanCount = 0; }
            mod.AnzhuangPJCanshu = txtanzhuangPJCanshu.Text.Trim();
            if (txtanzhuangPJCount.Text.Trim() != "")
            {
                mod.AnzhuangPJCount = Convert.ToInt32(txtanzhuangPJCount.Text.Trim());
            }
            else
            {
            ...
            {
                mod.Yuanqijian1Count1 = Convert.ToInt32(txtyuanQiJian1Count.Text.Trim());
            }
            else
            {
            ...
            {
                mod.Yuanqijian2Count1 = Convert.ToInt32(txtyuanQiJian2Count.Text.Trim());
            }
            else
            {
            ...
            {
                mod.Yuanqijian3Count1 = Convert.ToInt32(txtyuanQiJian3Count.Text.Trim());
            }
            else
            {
            ...
            {
                mod.Yuanqijian4Count1 = Convert.ToInt32(txtyuanQiJian4Count.Text.Trim());
            }
            else
            {
