<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BiaoShiImageManage.aspx.cs" Inherits="OrderPrintWeb.ProductManage.BiaoShiImageManage" %>
            ...
            <ContentTemplate>
                <div id="ListArea" class="listarea">
                    <div id="OptArea" class="optarea">
                        ...
                        <div class="fr">
                            <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./ProductManage/AddBiaoShiImage.aspx','编辑标示位置信息','30%','70%')"
                            ...
                            <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void;" onclick="ListPageControl.OpenBox('./ProductManage/AddBiaoShiImage.aspx?id=<%# Eval("imgId") %>','编辑标示位置信息','30%','70%')">编辑</a>&nbsp;|&nbsp;
