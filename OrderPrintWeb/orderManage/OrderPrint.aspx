<%@ Page Language="C#" AutoEventWireup="true" Inherits="orderManage_OrderPrint" CodeBehind="OrderPrint.aspx.cs" %>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="details">
            <div class="rightinfo" id="RightInfoArea">
                <table class="form" cellpadding="4" cellspacing="0" align="center" width="100%" style="padding-top:10px;">
                    ...
                    <tr>
                        <td class="title2" colspan="8" style="font-size:14px; font-weight:bold;">产品信息<br />
                            <hr />
                        </td>
                    </tr>
                    <tr>
        ...
        <script type="text/javascript">
            ...
            function printBZBQ() {
                ...
                window.open(Config.AppStartupDir + 'PrintBZBQ.aspx?proType=' + proType + '&orderNum=' + orderNum + '&customNum=' + customNum + '&proNum=' + proNum, '打印外包装标签', '80%', '90%', false, false);
            }
        </script>
    </form>
</body>
