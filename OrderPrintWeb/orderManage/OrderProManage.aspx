                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb" style="margin-top:5px;">
                    ...
                    <asp:Repeater ID="rpt_userinfo" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <a href="javascript:void;" onclick="ListPageControl.OpenBox('./orderManage/OrderPrint.aspx?id=<%# Eval("orderDetailId") %>','打印产品订单','1050px','500px')"><%# Eval("orderNum")%></a>
                                ...
                                <td>
                                    <a href="javascript:void;" onclick="ListPageControl.OpenBox('./orderManage/OrderPrint.aspx?id=<%# Eval("orderDetailId") %>','打印产品订单','1050px','500px')">详细</a>
