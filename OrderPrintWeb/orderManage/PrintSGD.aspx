                        ...
                        <td>
                            ...
                            <table class="form tb" cellpadding="0" cellspacing="0" style="width: 768px; border-top: 1px solid #000000; border-left: 1px solid #000;" align="center">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <%-- <div style="float:left; height:100%; border-right:1px solid #000;">
                                        ...
                                        <table id="tbPeixianYaoqiu" cellpadding="0" cellspacing="0" border="0" style="margin-right: 0px; padding-right: 0px;">
                                            <tr>
                                                <td rowspan="2" style="border-bottom: 0px;width:50%;">配线要求</td>
                                                <td style="border: 0px; border-bottom: 1px solid #000; width:50%;" >输入</td>
                                            </tr>
                                            <tr>
                                                <td style="border: 0px;" >输出</td>
                                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="5" colspan="4" style="width:320px;">其他制作要求<div id="txtremark" runat="server" style="width: 98%;"></div>
                                    </td>

                                </tr>
                                <tr>
                                    <td colspan="5" rowspan="4">
                                        <asp:Image ID="imgWaiXingTZ" runat="server" Height="160" Style="max-width: 300px;" />&nbsp;&nbsp;<%--<asp:Image ID="imgBisoShiImg" runat="server" Width="160" Height="160" />--%></td>
                                ...
                                <%-- <tr>
                        <td colspan="9" style="font-weight: bold; text-align: center;">客户特殊要求</td>
                    </tr>
                    <tr>
                        <td colspan="9">
