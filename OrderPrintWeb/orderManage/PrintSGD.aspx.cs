...
public partial class orderManage_PrintSGD : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                suigongdan = Request.QueryString["withWorkNo"].ToString();
                lblSuigongdan.Text = Request.QueryString["withWorkNo"].ToString();
            }
            ...
            if (Request.QueryString["proType"] != null && Request.QueryString["proType"].ToString() != "")
            {
                ...
                if (mod != null)
                {
                    ...
                    //{
                    //    imgBisoShiImg.ImageUrl = mod.biaoShiPicture;
                    //    imgBisoShiImg.Visible = true;
                    //}
                    //else
                    //{
                    //    imgBisoShiImg.Visible = false;
                    //}
                    ...
                    //txtNeiBZ.Text = mod.NeiBZ.ToString();
                    ...
                    if (paramMod != null)
                    {
                        ...
                        //if (paramMod.IsWriteFahuoInfo == 1 && paramMod.IsWriteXianChang == 1)
                        //{
                        //    ProOrdersMOD ProOrderMod = ProOrdersBLL.GetModel(orderNum);
                        //    if (ProOrderMod != null)
                        //    {
                        //        if (ProOrderMod.ShuRuXianchang != "")
                        //        {
                        //            txtshuRuXC.Text = ProOrderMod.ShuRuXianchang;
                        //        }
                        //        else
                        //        {
                        //            txtshuRuXC.Text = mod.shuRuXC;
                        //        }
                        //        if (ProOrderMod.ShuChuXianchang != "")
                        //        {
                        //            txtshuChuXC.Text = ProOrderMod.ShuChuXianchang;
                        //        }
                        //        else
                        //        {
                        //            txtshuChuXC.Text = mod.shuChuXC;
