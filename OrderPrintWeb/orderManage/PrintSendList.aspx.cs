    ...
    protected void btnPrint_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (div1.Visible == true)
        {
            ...
            if (result)
            {
                ...
                //ScriptManager.RegisterStartupScript(Page, typeof(Page), "BGYPSQLB", "window.open('PrevSendList.aspx?orderNum=" + orderNum + "&customerNo=" + customNum + "&proType=" + proType + "&withWorkNo=" + withWorkNo + "&sendTime=" + lblPrintTime.Value.Trim() + "');", true);
                //ScriptManager.RegisterStartupScript(Page, typeof(Page), "BGYPSQLB", " window.close();", true);
            }
            else
            {
