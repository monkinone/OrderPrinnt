                ...
                <table id="tablePrint" align="center">
                    <tr>
                        <td>
                            ...
                            <table class="form tb" cellpadding="0" cellspacing="0" style="border-top: 1px solid #000; border-left-color: #000; width: 768px;" align="center" id="tabJingTai" runat="server">

                                <tr>
                                    <td>送样编号</td>
                                    <td width="100">
                                        <input type="text" style="width: 100px; border: 0;" /></td>
                                    <td>送样数量</td>
                                    <td width="100">
                                ...
                                <tr>
                                    ...
                                    <td>品牌</td>
                                    <td>
                                        <input type="text" style="width: 100px; border: 0;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>供应商编号</td>
                                ...
                                <tr>
                                    <td>是否为代用料</td>
                                    <td colspan="3">
                                        <input type="checkbox" disabled="disabled" />是&nbsp;&nbsp;<input type="checkbox" disabled="disabled" />否</td>
                                    <td>评样接受人</td>
                                    <td>
                                        <input type="text" style="width: 100px; border: 0;" /></td>
                            ...
                            <table style="width: 768px; margin-left: 6px; font-size: 20px; padding-left: 10px; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000;" cellpadding="0" cellspacing="0" align="center">
                                ...
                                <tr>
                                    <td>检验结论：</td>
                                    <td colspan="7">合格<input type="checkbox" disabled="disabled" /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td colspan="7">不合格<input type="checkbox" disabled="disabled" />&nbsp;&nbsp;需改进的项目：</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
