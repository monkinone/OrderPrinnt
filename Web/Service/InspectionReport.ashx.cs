...
{
    /// <summary>
    /// InspectionReport 的摘要说明
    /// </summary>
    public class InspectionReport : IHttpHandler
    {
        ...
        public void UpdatePrint(HttpContext context)
        {
            ...
            num= ProOrdersDetailBLL.UpdatePrintInfo(orderNum, proType, "printCCJYBGTime", "printCCJYBGCount");
