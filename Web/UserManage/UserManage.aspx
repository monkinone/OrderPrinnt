<%@ Page Language="C#" AutoEventWireup="true" Inherits="UserManage_UserManage" Codebehind="UserManage.aspx.cs" %>
            ...
            <div id="ListArea" class="listarea">
                <div id="OptArea" class="optarea">
                    ...
                    <asp:ImageButton ID="IBtn_Delete" runat="server" OnClick="Delete_Click" ImageUrl="../themes/default/images/btn/btn_delete_w_h.png"
                        ...
                        <img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./UserManage/AddUser.aspx','编辑用户信息','30%','60%')" src="~/themes/default/images/btn/btn_new_w_h.png" alt="添加" title="添加" />
                    </div>
                </div>
                        ...
                        <asp:Repeater ID="rpt_userinfo" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hiddId" runat="server" Value='<%#Eval("userid") %>' />
                                    ...
                                    <td>
                                        <a href="javascript:void;" onclick="ListPageControl.OpenBox('./UserManage/AddUser.aspx?id=<%# Eval("userid") %>','编辑用户信息','30%','50%')">
                                            编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
