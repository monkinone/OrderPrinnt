    ...
    <form id="form1" runat="server" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="details">
            <div class="rightinfo" id="RightInfoArea" >
                <table class="" cellpadding="4" cellspacing="0" align="center" width="30%">
                    <tr>
                        <td colspan="2" style="text-align:center;"><span class="loginTishi" id="spanTishi" runat="server">您是首次登录，请修改密码</span></td>
                    </tr>
                    <tr>
                        <td class="title1">请输入原密码：
                        </td>
                        <td class="info">
                            <asp:TextBox ID="txtOldPass" runat="server" CssClass="tbox" datatype="*"
                                nullmsg="请输入原密码！" errormsg="请输入原密码！"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="title1">请输入新密码：
                        </td>
                        <td class="info">
                            <asp:TextBox ID="txtNewPass" runat="server" CssClass="tbox" datatype="*"
                                nullmsg="请输入新密码！" errormsg="请输入新密码！"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="title1">请再次输入新密码：
                        </td>
                        <td class="info">
