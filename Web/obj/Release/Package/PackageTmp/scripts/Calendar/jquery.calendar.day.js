			...
			week : {
				...
				cal : function( data ){
					...
					data.elements.dayblock.css({
						width	: data.cache.resourceWidth-20.5,
						height	: data.cache.dayHeight
					});
					
					data.elements.resourcelabel.css({
						width	: data.cache.resourceWidth-20,
						height	: '100%'
					})
					
					data.elements.datelabel.css({
						width	: data.cache.dayWidth-20,
						height	: '100%'
					});
				...
				position : function( speed, ease, detect ){
					...
					if( data && values ){
						...
						$events.each(function( i, event ){
							...
							// Calculate the new CSS.//liuxd add
							var newStylesMain = {
								...
								width			: ( values.resource !== null ? data.cache.resourceWidth-20 : data.cache.dayWidth-20 ) - 1,
