        ...
        function isShowPrint() {
            if ($('#txtcustomNum').val() != '') {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "/Service/Order.ashx",
                    data: { opr: "IsShowPrint", customerNum: $('#txtcustomNum').val() },
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
                    success: function (data) {
                        if (data.d == 0) {
        ...
        function isExistCustom() {
            if ($('#txtcustomNum').val() != '') {
                $.ajax({
                    ...
                    async: false,
                    url: "/Service/Order.ashx",
                    data: { opr: "isExistCustom", customerNum: $('#txtcustomNum').val() },
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
                    success: function (data) {
                        if (data.d == '无') {
                            ...
                            $.ajax({
                                ...
                                async: false,
                                url: "/Service/Order.ashx",
                                data: { opr: "GetHetongTishi", customerNum: $('#txtcustomNum').val() },
                                contentType: "application/json;charset=utf-8",
                                dataType: "json",
                                success: function (data) {
                                    $('#tishi').html(data.d);
        ...
        function isExistOrderNum() {
            if ($('#txtorderNum').val() != "") {
                $.ajax({
                    ...
                    async: false,
                    url: "/Service/Order.ashx",
                    data: { opr: "isExistOrderNum", orderNum: $('#txtorderNum').val() },
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
                    success: function (data) {
                        if (data.d == 0) {
