<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteOrder.aspx.cs" Inherits="OrderPrintWeb.orderManage.DeleteOrder" %>
    ...
    <form id="form1" runat="server" autocomplete="off">
        <div id="ListArea" class="listarea">
            <div id="OptArea" class="optarea">
                ...
                <div class="fr">
                    <%--<img class="btn" id="btnSave" runat="server" onclick="ListPageControl.OpenBox('./orderManage/AddOrder.aspx','下发订单信息','80%','90%')"
            ...
            <div id="List" class="listS">
                <table class="form" border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                        <td class="title1">
                            起始日期:<input class=" tbox" readonly="readonly" id="txtBeginTime" type="text" name="txtTime" onclick="WdatePicker()"
                                runat="server" />
                            &nbsp;&nbsp;截止日期:<input class=" tbox" readonly="readonly" id="txtEndTime" type="text" name="txtTime" onclick="WdatePicker()"
                                runat="server" />
                             &nbsp;&nbsp;客户名称:<asp:TextBox ID="txtCompanyName" runat="server" CssClass="tbox"></asp:TextBox>
                             &nbsp;&nbsp;订单编号:<asp:TextBox ID="txtorderNum" runat="server" CssClass="tbox"></asp:TextBox>
                             &nbsp;&nbsp;产品型号:<asp:TextBox ID="txtProduct" runat="server" CssClass="tbox"></asp:TextBox>
                             &nbsp;&nbsp;<asp:Button ID="btnSearchOrder" runat="server" Text="搜索" CssClass="current" OnClick="btnSearchOrder_Click" />
                        </td>
                       
                    </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb fl" style="width: 100%; margin-top: 10px;">
                    <tr>
                    </tr>
                    <tr>
                    ...
                    <asp:Repeater ID="rpt_userinfo" runat="server" OnItemCommand="rpt_userinfo_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# Eval("Remark1")%></td>
                                <td>
                                  <%--  <a href="javascript:void;" onclick="ListPageControl.OpenBox('./orderManage/EditOrder.aspx?id=<%# Eval("orderNum") %>','下发订单信息','70%','90%')">编辑</a>&nbsp;|&nbsp;--%>
