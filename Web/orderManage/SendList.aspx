...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function openPrintWindow() {
            ...
            var pageIndex = $("#hiddenPageIndex").val();
            var txtcompanyName = $("#txtcompanyName").val();
            var txtproType = $("#txtproType").val();
            var url='PrintFaHuoList.aspx?pageSize='+pageSize+"&pageIndex="+pageIndex+"&txtcompanyName="+txtcompanyName+"&txtproType="+txtproType;
...
<body>
    ...
    <!--隐藏区s-->
    <input type="hidden" id="hiddenPageSize" value="12" runat="server"/>
    <input type="hidden" id="hiddenPageIndex" value="1" runat="server"/>
     <!--隐藏区e-->
</body>
</html>
